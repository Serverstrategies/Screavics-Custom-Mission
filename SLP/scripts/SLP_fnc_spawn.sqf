...
///////////////////////////////////Infantry////////////////////////////////////////
SLP_fnc_Infantry = {
private ["_infgrp_num","_infgrp_size","_newunit","_unit","_spawnname","_grp","_newunits","_leaderunit","_lunit","_side","_delay","_randompos","_infgrp","_temparray","_Leaderunits","_units","_task","_string","_position","_infskill"];
...
//		hint format  ["SKill is %1",_skill];
	for "_s" from 2 to _infgrp_size do {	
        ...
        [_spawnname,_position,_grp,_task,_string] spawn SLP_task;
...
_string = _this select 9;
_int = _this select 10;
...
//////////// Fill cargo with infantry if set to true////////////////////////////////////////////////
		if (_vehgrp_inf	) then {
			_newunits =  _units - [_units select 0, _unit];
